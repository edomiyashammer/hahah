...
from .models import Category, Product,Subcategory, Post
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_mail(
                ...
                f"Name: {name}\nEmail: {email}\n\nMessage:\n{message}",
                "support@giyaamarket.com",  # Change this to your email address
                [
...
def product_create(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            videolink = form.cleaned_data["videolink"]
            ...
            send_mail(
                ...
                "dragonhammer53@gmail.com",  # Sender's email address
